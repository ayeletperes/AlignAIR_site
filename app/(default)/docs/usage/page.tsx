        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="py-12 md:py-20 border-t border-gray-800">
            ...
            <div className="max-w-4xl mx-auto text-center pb-12 md:pb-16">
              ...
              <pre className="bg-gray-800 text-green-400 p-4 rounded text-left overflow-x-auto mb-8">
                <code>
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full text-gray-400 text-left">
                  <thead className="bg-gray-900">
                    <tr>
                      <th className="py-3 px-4 border-b border-gray-700">Parameter</th>
                      <th className="py-3 px-4 border-b border-gray-700">Description</th>
                    </tr>
                  </thead>
                  <tbody className="bg-black">
                    {/* Model Settings */}
                    <tr><td className="py-3 px-4 font-semibold text-white" colSpan={2}>Model Settings</td></tr>
                    <tr><td className="py-2 px-4">model_checkpoint</td><td className="py-2 px-4">Path to model weights. Docker ships with <code className="bg-gray-700 px-1 rounded">IGH_S5F_576</code> and <code className="bg-gray-700 px-1 rounded">IGL_S5F_576</code> located in <code className="bg-gray-700 px-1 rounded">/app/pretrained_models/</code>.</td></tr>
                    <tr><td className="py-2 px-4">chain_type</td><td className="py-2 px-4">Specify <code className="bg-gray-700 px-1 rounded">heavy</code> or <code className="bg-gray-700 px-1 rounded">light</code> chain for alignment functionality.</td></tr>
                    <tr><td className="py-2 px-4">max_input_size</td><td className="py-2 px-4">Maximum input window size. Default is <code className="bg-gray-700 px-1 rounded">576</code>. Longer reads are trimmed during preprocessing if needed.</td></tr>
                    ...
                    {/* Input and Output */}
                    <tr><td className="py-3 px-4 font-semibold text-white" colSpan={2}>Input and Output</td></tr>
                    <tr><td className="py-2 px-4">sequences</td><td className="py-2 px-4">Path to sequence file (CSV/TSV/FASTA). For tables, must have a <code className="bg-gray-700 px-1 rounded">sequence</code> column.</td></tr>
                    <tr><td className="py-2 px-4">save_path</td><td className="py-2 px-4">Path to save output (AIRR Schema CSV format).</td></tr>
                    <tr><td className="py-2 px-4">airr_format</td><td className="py-2 px-4">Set <code className="bg-gray-700 px-1 rounded">True</code> to output full AIRR Schema. Default is essential columns only.</td></tr>

                    {/* Thresholds */}
                    <tr><td className="py-3 px-4 font-semibold text-white" colSpan={2}>Threshold Settings</td></tr>
                    <tr><td className="py-2 px-4">v_allele_threshold</td><td className="py-2 px-4">Threshold for V allele calling (default: 0.75). <a href="#">[See thresholding explanation]</a></td></tr>
                    ...
                    <tr><td className="py-3 px-4 font-semibold text-white" colSpan={2}>Preprocessing and Corrections</td></tr>
                    <tr><td className="py-2 px-4">translate_to_asc</td><td className="py-2 px-4">Output ASC alleles instead of IMGT names if set <code className="bg-gray-700 px-1 rounded">True</code>. Default is <code className="bg-gray-700 px-1 rounded">False</code>.</td></tr>
                    ...
                    {/* Metadata Configs */}
                    <tr><td className="py-3 px-4 font-semibold text-white" colSpan={2}>Reference Metadata and Configs</td></tr>
                    ...
                    {/* Debugging */}
                    <tr><td className="py-3 px-4 font-semibold text-white" colSpan={2}>Debugging Options</td></tr>
