  ...
  thomask90/alignair:latest
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 py-12 md:py-20 border-t border-gray-800">
            ...
            {/* Card: FAQ & Troubleshooting */}
            <div className="group">
              <div className="bg-gradient-to-br from-red-500 to-rose-500 p-0.5 rounded-2xl transition-all duration-300 hover:scale-105">
                <div className="bg-gray-900 rounded-2xl p-6 h-full">
                  <div className="flex items-center mb-4">
                  ...
                  <p className="text-gray-400 mb-6">
                    Frequently asked questions, common issues, troubleshooting guide, and solutions to help you get unstuck quickly.
                  </p>
                  <Link href="/docs/faq" className="text-red-400 hover:text-red-300 text-sm font-medium flex items-center group-hover:translate-x-1 transition-transform">
                    Get Help
                    <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <Link href="/docs/installation" className="group bg-gray-900 hover:bg-gray-800 rounded-xl p-6 border border-gray-800 hover:border-gray-700 transition-all">
              <div className="flex items-center mb-3">
                <div className="w-8 h-8 bg-blue-600 rounded-lg flex items-center justify-center mr-3">
                  <span className="text-white font-bold text-sm">1</span>
                </div>
                <h3 className="text-lg font-bold text-white">Docker Quick Start</h3>
              </div>
            ...
            <Link href="/docs/usage" className="group bg-gray-900 hover:bg-gray-800 rounded-xl p-6 border border-gray-800 hover:border-gray-700 transition-all">
              <div className="flex items-center mb-3">
                <div className="w-8 h-8 bg-green-600 rounded-lg flex items-center justify-center mr-3">
                  <span className="text-white font-bold text-sm">2</span>
                </div>
                <h3 className="text-lg font-bold text-white">Parameter Guide</h3>
              </div>
              <p className="text-gray-400 text-sm group-hover:text-gray-300">
            ...
            <Link href="/docs/technical/architecture" className="group bg-gray-900 hover:bg-gray-800 rounded-xl p-6 border border-gray-800 hover:border-gray-700 transition-all">
              <div className="flex items-center mb-3">
          ...
          <div className="bg-gradient-to-r from-gray-900 to-gray-800 rounded-2xl p-8 border border-gray-700">
            <div className="text-center">
              ...
              <div className="flex justify-center space-x-4">
                <a href="https://github.com/MuteJester/AlignAIR" className="bg-gray-800 hover:bg-gray-700 text-white px-6 py-3 rounded-lg font-medium transition-colors inline-flex items-center">
                ...
                <a href="https://github.com/MuteJester/AlignAIR/issues" className="bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-lg font-medium transition-colors inline-flex items-center">
                  <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* Recent Updates */}
        <div className="text-center">
          <div className="bg-blue-900/30 rounded-2xl p-8 border border-blue-700">
            ...
            <h2 className="text-2xl font-bold text-white mb-4">📝 Documentation Updates</h2>
            ...
            <div className="flex justify-center">
              <Link href="/docs/changelog" className="text-blue-400 hover:text-blue-300 font-medium inline-flex items-center">
                View Recent Changes
                <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
