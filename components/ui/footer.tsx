...
import Logo from '@/public/images/alignair_logo.svg'
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              <div className="mb-2">
                ...
                <Link href="/" className="inline-block" aria-label="Cruip">
                  ...
                  <Image className="shadow-md" src={Logo} width={70} height={70} alt="logo" />
                </Link>
              </div>
              <div className="text-gray-400">Improving Adaptive Immune Receptor Alignment</div>
            </div>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
              ...
              <li className="ml-4">
                <Link href="https://github.com/MuteJester/AlignAIRR" className="flex justify-center items-center text-purple-600 bg-gray-800 hover:text-gray-100 hover:bg-purple-600 rounded-full transition duration-150 ease-in-out" aria-label="Github">
                  <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">&copy; AlignAIR.ai All rights reserved.</div>
